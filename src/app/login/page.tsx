  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#090B11] font-sans p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] rounded-full bg-[#0A1628]/10 blur-[120px]" />
        <div className="absolute bottom-[20%] right-[10%] w-[300px] h-[300px] rounded-full bg-[#0A1628]/5 blur-[120px]" />
      </div>
      ...
      >
        ...
        <p className="mt-8 text-center text-xs text-slate-500 font-semibold">
          New to Mockmate?{' '}
          <Link href="/signup" className="text-[#3b82f6] hover:text-[#60a5fa] font-black tracking-wide uppercase transition-colors ml-1">
            Create Account
          </Link>
        </p>
      </motion.div>
